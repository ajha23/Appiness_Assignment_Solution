...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        if (user.firstName && user.lastName && user.username && user.password && user.phone && user.address && user.doj) {
        ...
        return (
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user.doj ? ' has-error' : '')}>
                        <label htmlFor="doj">Date of joining</label>
                        <input type="date" className="form-control" name="doj" value={user.doj} onChange={this.handleChange} />
                        {submitted && !user.doj &&
                            <div className="help-block">Date of joining is required</div>
                        }
                    </div>
